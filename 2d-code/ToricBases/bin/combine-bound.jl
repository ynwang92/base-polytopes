...
# modified to stop at lower bound nbound
...
function process_canonical_files(k::Integer, m_values::Vector{Int}, 
                              directory::String, verbose::Bool, bound::Integer)
...
function main()
   ...
   process_canonical_files(args["k"], m_values, args["directory"], args["verbose"],  args["bound"])
end
